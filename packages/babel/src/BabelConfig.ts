import {BaseConfig, JsExtension, RuleOptimizationAwareConfig, getLoader} from '@webpack-config-suite/core';
...
export class BabelConfig extends RuleOptimizationAwareConfig {
